...
import CategoryModal, { IncomeCategory } from '../../../../components/income/CategoryModal';
import PaymentMethodModal, { PaymentMethod } from '../../../../components/income/PaymentMethodModal';
      ...
      <div className={`flex-1 transition-all duration-300 ease-in-out ${mainContentMargin}`}>
        ...
        <div className="w-full h-full flex justify-center items-center p-4 md:p-10">
          <div className="w-full max-w-5xl md:w-[70%] h-[90%] border-2 border-blue-600 rounded-2xl p-6 md:p-10 overflow-y-auto bg-white shadow-md">
            {/* Title */}
            <h1 className="text-4xl font-bold text-[#1D2AA9] mb-6">Income</h1>
