      ...
      <div className="w-full max-w-7xl min-h-[calc(100dvh-80px)] flex items-center justify-center py-8">
        <div className="w-full max-w-7xl rounded-3xl flex flex-col lg:flex-row items-center gap-20">
          ...
          <div className="flex-1 w-full flex flex-col justify-start items-start max-w-lg">
            ...
            <p className="mt-6 text-lg md:text-xl font-medium text-soft-off text-black font-grotesk max-w-lg mb-10">
          ...
          >
            ...
            <button
              ...
              className="self-end w-30 mt-4 py-3 px-8 bg-[#1F299C] hover:bg-[#343fb4] rounded-3xl text-white focus:outline-none focus:ring-2 focus:ring-[#1F299C] focus:ring-opacity-50 disabled:opacity-60"
