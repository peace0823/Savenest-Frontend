            ...
            <div className="w-full max-w-7xl rounded-3xl flex flex-col lg:flex-row items-center gap-20">
                ...
                <div className="flex-1 w-full flex flex-col justify-start items-start max-w-lg">
                    ...
                    <ul className="mt-6 text-sm md:text-lg font-black text-black font-grotesk space-y-3">
                        <li className="flex items-start"><span className="mr-3 text-[#1F299C] font-bold">✓</span>Almost there! Verify Your Email</li>
                        <li className="flex items-start"><span className="mr-3 text-[#1F299C] font-bold">✓</span> We sent a 4-digit code to your email.</li>
                        <li className="flex items-start"><span className="mr-3 text-[#1F299C] font-bold">✓</span> Check your inbox and enter the code below.</li>
                        <li className="flex items-start"><span className="mr-3 text-[#1F299C] font-bold">✓</span> Confirm Code</li>
                    </ul>
                ...
                >
                    ...
                    <div className="w-full flex justify-between items-center">
                        <Link href="/resend-otp" className="text-sm font-bold md:text-lg text-[#1F299C] hover:underline">
                            Resend OTP
                        </Link>
                        <button
                            onClick={() => {
